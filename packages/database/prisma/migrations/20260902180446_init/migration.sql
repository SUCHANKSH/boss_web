...
-- CreateEnum
CREATE TYPE "MediaScope" AS ENUM ('PUBLIC_PRODUCT', 'PRIVATE_CUSTOMIZATION');

-- CreateEnum
CREATE TYPE "InventoryPolicy" AS ENUM ('TRACKED', 'MADE_TO_ORDER', 'UNLIMITED');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING_PAYMENT', 'CONFIRMED', 'PROCESSING', 'CUSTOMIZATION_REQUIRED', 'IN_PRODUCTION', 'PACKED', 'SHIPPED', 'OUT_FOR_DELIVERY', 'DELIVERED', 'CANCELLED', 'REFUNDED');
...
CREATE TABLE "ProductVariant" (
    ...
    "inventoryPolicy" "InventoryPolicy" NOT NULL DEFAULT 'TRACKED',
    "isActive" BOOLEAN NOT NULL DEFAULT true,
...
-- CreateTable
CREATE TABLE "CustomizationSchema" (
    "id" TEXT NOT NULL,
    "productId" TEXT NOT NULL,
    "version" INTEGER NOT NULL DEFAULT 1,
    "fields" JSONB NOT NULL,

    CONSTRAINT "CustomizationSchema_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "CustomizationSchema_productId_key" ON "CustomizationSchema"("productId");
...
-- AddForeignKey
ALTER TABLE "CustomizationSchema" ADD CONSTRAINT "CustomizationSchema_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;
